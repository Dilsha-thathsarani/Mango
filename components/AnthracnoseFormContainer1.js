...
const AnthracnoseFormContainer1 = memo(() => {
  ...
  return (
    <View style={styles.vectorParent}>
      ...
      <Text style={[styles.text, styles.textTypo]}>17/05/2023</Text>
      ...
      />
      <Image
        style={[styles.icon, styles.picLayout]}
        contentFit="cover"
        source={require("../assets/1684830428352-1.png")}
      />
    </View>
  );
});
...
export default AnthracnoseFormContainer1;
